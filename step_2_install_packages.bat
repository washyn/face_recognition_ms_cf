...
@REM - NumPy .- NumPy is the fundamental package for array computing with Python.(numpy)
@REM - Microsoft cognitive services .- Python SDK for the Cognitive Face API (cognitive-face)
